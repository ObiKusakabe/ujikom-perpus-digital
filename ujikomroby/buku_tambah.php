            ...
            <div class="col-md-12">
                <form method="post">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $query = mysqli_query($koneksi, "INSERT INTO t_buku(judul,kategoriID,deskripsi,penulis,penerbit,tahunTerbit) VALUES ('$judul','$id_kategori','$deskripsi','$penulis','$penerbit','$tahunTerbit')");
                        if ($query) {
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                        <textarea class="form-control" name="deskripsi" placeholder="" id="floatingTextarea2" style="height: 100px" required></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
